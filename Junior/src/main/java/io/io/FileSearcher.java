...
public class FileSearcher {
    ...
    private static void printHelp() {
        System.out.println("Подсказка:" + LN +
                "-d - обязательный параметр. Каталог в котором искать." + LN +
                "-n - обязательный параметр. Маска файла или имя файла." + LN +
                "-o - обязательный параметр. Название лога, куда будут записаны результаты. Лог-файл появится в temp-папке вашей ОС." + LN +
                "-e - необязательный параметр. Флаг, если указан, то искать будет все файлы за исключением указанного после параметра -n.");
    }
